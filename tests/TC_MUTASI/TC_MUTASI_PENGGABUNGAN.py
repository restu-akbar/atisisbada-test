...
#python -m unittest tests.TC_MUTASI.TC_MUTASI_PENGGABUNGAN
class TC_MUTASI_PENGGABUNGAN(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        driver = cls.driver
        TC_MUTASI_PENGGABUNGAN.nibar = 152415
        time.sleep(2)
    ...
    #@unittest.skip("test")
    def test_TC_MUTASI_PENGGABUNGAN_001(self):
        print("test_TC_MUTASI_PENGGABUNGAN_001")
        driver = self.driver
        ...
        save_get_alert(
            ...
            with_button=False,
            test_name="TC_MUTASI_PENGGABUNGAN_001",
        )
        time.sleep(3)
        
        TC_MUTASI_PENGGABUNGAN.switch_to_main_window(driver) 
            
    # @unittest.skip("test 2")
    def test_TC_MUTASI_PENGGABUNGAN_002(self):
        print("test_TC_MUTASI_PENGGABUNGAN_002")
        driver = self.driver
        driver.get(f"{self.url}index.php?Pg=09&SPg=01&SSPg=03&mutasi=4&menu=pelaporan")
        time.sleep(2)
        ...
        checkbox(driver, identifier=1, by="index", table_selector="table.koptable")
        time.sleep(2)
        href_button(driver, "javascript:batalPenggabungan()")
        time.sleep(2)
        ...
        save_get_alert(
            ...
            with_button=False,
            test_name="TC_MUTASI_PENGGABUNGAN_002",
        )
