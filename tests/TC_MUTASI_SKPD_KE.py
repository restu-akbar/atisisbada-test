...
class TC_MUTASI_SKPD_KE(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        TC_MUTASI_SKPD_KE.nibar = os.getenv("nibar")
    ...
    def setUp(self):
        ...
        driver = self.driver
        if self._testMethodName == "test_TC_MUTASI_SKPD_KE_001":
            driver.get(f"{self.url}index.php?Pg=05&SPg=03&jns=tetap")
            filter_nibar_pembukuan(self.driver, self.nibar)
        else:
            driver.get(
                f"{self.url}index.php?Pg=09&SPg=01&SSPg=03&mutasi=1&menu=pelaporan"
            )
    ...
    def test_TC_MUTASI_SKPD_KE_001(self):
        driver = self.driver
        ...
        print_result(alert_text, "Mutasi Selesai !", test_name="TC_MUTASI_SKPD_KE_001")

        self._return_to_main_and_close_extras()

    def test_TC_MUTASI_SKPD_KE_002(self):
        driver = self.driver
        time.sleep(1)
        ...
        print_result(
            ...
            test_name="TC_MUTASI_SKPD_KE_002",
        )
